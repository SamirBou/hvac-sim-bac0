...
3. You can provide an INI-style config file to set the device name, instance, and network address. Example provided in repo root (`config.ini`):
...
3. Use `--debug` for verbose network logs
